# TITANE∞ LITE — Cognitive Operating System

![CI/CD Status](https://github.com/KallokTherok1994/TITANE_-LITE/actions/workflows/ci.yml/badge.svg?branch=MAIN)
[![Version](https://img.shields.io/badge/Version-v27.0.0-blue.svg)](https://github.com/KallokTherok1994/TITANE_-LITE/releases/tag/v27.0.0)
...
```bash
# Télécharger le DEB
wget https://github.com/KallokTherok1994/TITANE_-LITE/releases/download/v27.0.0/Titan-Stable_27.0.0_amd64.deb
...
```bash
wget https://github.com/KallokTherok1994/TITANE_-LITE/releases/download/v27.0.0/Titan-Stable_27.0.0_amd64.AppImage
...
```bash
git clone https://github.com/KallokTherok1994/TITANE_-LITE.git
cd TITANE_LITE
```
...
- 🐛 **Issues**: [GitHub Issues](https://github.com/KallokTherok1994/TITANE_-LITE/issues)
- 💬 **Discussions**: [GitHub Discussions](https://github.com/KallokTherok1994/TITANE_-LITE/discussions)
