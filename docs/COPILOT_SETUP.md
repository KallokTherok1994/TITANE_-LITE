...
This document describes the complete GitHub Copilot instructions setup for TITANE_LITE, following [GitHub's best practices for Copilot coding agent](https://docs.github.com/en/copilot/tutorials/coding-agent/get-the-best-results).
