...
```
src/core/persona/*          → TITANE_LITE v13 headers (15 fichiers)
src/core/visual/*           → TITANE_LITE v13 headers (9 fichiers)
src/core/cognitive/*        → TITANE_LITE v13 headers (5 fichiers)
src/core/archetypes/*       → TITANE_LITE v13 headers (4 fichiers)
src/core/engines/*          → TITANE_LITE v13 headers (3 fichiers)
...
1. **Router v15 vs v13**
   ...
   // License header: TITANE_LITE v13
   ```
