...
Tous les composants sont correctement configurés pour l'environnement natif Pop!_OS. Le projet TITANE_LITE est prêt pour le développement et la compilation en mode natif avec performances optimales.
