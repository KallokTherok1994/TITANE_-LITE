...
```bash
./runtime/dev/tauri.dev.conf.json.backup:    "beforeBuildCommand": "cd /home/titane-os/Documents/GitHub/TITANE_LITE && pnpm exec vite build",
...
```json
"beforeBuildCommand": "cd /home/titane-os/Documents/GitHub/TITANE_LITE && npx vite build"
```

**Après:**

```json
"beforeBuildCommand": "cd /home/titane-os/Documents/GitHub/TITANE_LITE && /home/titane-os/.local/share/pnpm/pnpm exec vite build"
```
