**TITANE∞ API Documentation v13.0.0**
...
### Guides Principaux
- [README Complet](_media/README.md)
- [Architecture Technique](_media/ARCHITECTURE.md)
- [Documentation Modules](_media/MODULES.md)
...
- **[Shared Types](_media/types.rs)** - Types communs système
- **[Utils](_media/utils.rs)** - Utilitaires mathématiques
...
Consultez [DEVELOPER_GUIDE.md](_media/DEVELOPER_GUIDE.md) pour contribuer.
