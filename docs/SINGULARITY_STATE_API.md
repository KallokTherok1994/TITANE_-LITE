...
- ✅ **Persistence**: JSON (~/.local/share/TITANE_LITE/)
...
console.log('✅ State saved to ~/.local/share/TITANE_LITE/singularity_state.json');
```

**Path**: `~/.local/share/TITANE_LITE/singularity_state.json`
