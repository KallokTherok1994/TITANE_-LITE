/**
 * TITANE_LITE v21.0.0 — Visual States Design System ULTIMATE
 ...
 *
 * ✨ v21 EXTENSIONS:
 * - Multi-dimensional state system (Cognitive + Emotional + Load + Context)
...
/**
 * Cognitive States (9 core states)
...
/**
 * Conversation Context (6 contexts)
...
/**
 * TITANE∞ Complete State (Multi-dimensional)
...
/**
 * Visual Configuration (Computed Output)
...
// ═══════════════════════════════════════════════════════════════════
// 🎨 v19 LEGACY TYPES (PRESERVED FOR COMPATIBILITY)
// ═══════════════════════════════════════════════════════════════════
...
/**
 * Legacy Visual State (v19 - kept for backward compatibility)
...
/**
 * Legacy State Visual Config (v19 - kept for backward compatibility)
...
// ═══════════════════════════════════════════════════════════════════
// 📊 v19 LEGACY CONFIGURATIONS (PRESERVED)
// ═══════════════════════════════════════════════════════════════════
 ...
 */
export function getStateVisuals(state: VisualState): StateVisualConfig {
 ...
 */
export function canTransition(from: VisualState, to: VisualState): boolean {
  // Some states cannot transition directly (e.g., error should clear first)
  const invalidTransitions: [VisualState, VisualState][] = [
    ['error', 'speaking'],
    ['error', 'thinking'],
  ];

  return !invalidTransitions.some(([f, t]) => f === from && t === to);
}
 ...
 */
export function getSystemLoadLevel(loadPercentage: number): SystemLoadLevel {
...
/**
 * Cubic easing function (smooth acceleration/deceleration)
 */
export function cubicEasing(t: number): number {
