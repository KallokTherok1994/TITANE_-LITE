...
```bash
curl -fsSL https://raw.githubusercontent.com/KallokTherok1994/TITANE_LITE/main/TITANE_POST_INSTALL_UBUNTU.sh | bash
```
...
```bash
# 1. Télécharger
wget https://raw.githubusercontent.com/KallokTherok1994/TITANE_LITE/main/TITANE_POST_INSTALL_UBUNTU.sh
...
https://github.com/KallokTherok1994/TITANE_LITE/issues
