/**
 * TITANE_LITE v∞ — Proprietary License
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
      ...
      <Card>
        ...
        >
          ...
          <div style={{ display: 'flex', justifyContent: 'flex-end' }}>
            <Button
              type="submit"
              disabled={!newSecretKey.trim() || !newSecretValue.trim() || saving}
            >
              Stocker
            </Button>
          </div>
      ...
      <Card>
        ...
        >
          ...
          <li>
            ⚠️ Les valeurs ne sont JAMAIS exposées au frontend (seulement statuts
            masqués).
          </li>
          <li>
            Kevin Thibault est le seul superAdmin autorisé à modifier les secrets
            critiques.
          </li>
        </ol>
      </Card>
