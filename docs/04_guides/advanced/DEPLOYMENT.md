...
# Output:
# src-tauri/target/release/bundle/msi/TITANE_LITE_24.2.0_x64_en-US.msi
# src-tauri/target/release/bundle/nsis/TITANE_LITE_24.2.0_x64-setup.exe

# Sign with code signing certificate
signtool sign /f cert.pfx /p password /t http://timestamp.digicert.com TITANE_LITE_24.2.0_x64-setup.exe

# Test installer
TITANE_LITE_24.2.0_x64-setup.exe /S  # Silent install
```
...
# Output:
# src-tauri/target/release/bundle/dmg/TITANE_LITE_24.2.0_x64.dmg
# src-tauri/target/release/bundle/macos/TITANE_LITE.app

# Sign with Apple Developer certificate
codesign --deep --force --verify --verbose --sign "Developer ID Application: Your Name" TITANE_LITE.app

# Notarize (required for macOS 10.15+)
xcrun notarytool submit TITANE_LITE_24.2.0_x64.dmg --apple-id user@example.com --password app-specific-password --team-id TEAMID

# Test
open TITANE_LITE_24.2.0_x64.dmg
```
