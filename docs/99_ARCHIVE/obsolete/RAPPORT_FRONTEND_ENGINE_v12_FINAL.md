...
5. 🔄 **Deploy**: utiliser `TITANE_LITE_PREDEPLOY_v12.sh` (7 stages automation)
...
**Déploiement:**
- ✅ Script automated ready (TITANE_LITE_PREDEPLOY_v12.sh)
...
./TITANE_LITE_PREDEPLOY_v12.sh  # 7-stage pipeline
```
