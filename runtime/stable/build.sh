...
echo "   ℹ️  This may take 5-15 minutes on first build (large Rust compilation)"
echo "   💡 Tip: Monitor with 'cargo build --release' in another terminal"
echo ""

# Set optimized flags for production build
export RUSTFLAGS="${RUSTFLAGS:--C debuginfo=0 -C lto=thin -C codegen-units=16}"
