...
1. **GitHub Issue** — [Create issue](https://github.com/KallokTherok1994/TITANE_LITE/issues/new)
   - Template: Bug report
   - Inclure: OS, version, logs, steps to reproduce

2. **Discussions** — [Discussions forum](https://github.com/KallokTherok1994/TITANE_LITE/discussions)
   - Questions générales
   - Community help
