...
src-tauri/target/release/bundle/
├── dmg/
│   └── TITANE_LITE_16.2.2_universal.dmg    (~20 MB)
└── macos/
...
src-tauri/target/release/bundle/
├── msi/
│   └── TITANE_LITE_16.2.2_x64_en-US.msi    (~16 MB)
└── nsis/
    └── TITANE_LITE_16.2.2_x64-setup.exe    (~15 MB)
```
...
```bash
# Ouvrir .dmg
open TITANE_LITE_16.2.2_universal.dmg
...
msiexec /i TITANE_LITE_16.2.2_x64_en-US.msi
