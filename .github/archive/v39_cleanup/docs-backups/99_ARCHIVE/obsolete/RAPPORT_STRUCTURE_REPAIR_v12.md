...
```
/home/titane_os/Documents/TITANE_NEWGEN/TITANE_LITE/
```
...
cd src-tauri
pwd
# Résultat: /home/titane_os/Documents/TITANE_NEWGEN/TITANE_LITE/src-tauri ✅
```
...
```bash
ls -la /home/titane_os/Documents/TITANE_NEWGEN/TITANE_LITE/src-tauri/
# Résultat:
# Cargo.toml      ✅
# Cargo.lock      ✅
# tauri.conf.json ✅
...
|---------|------|---------|
| **Racine** | ✅ OK | `/home/titane_os/Documents/TITANE_NEWGEN/TITANE_LITE` |
...
cd /home/titane_os/Documents/TITANE_NEWGEN/TITANE_LITE/docs
../script.sh

# Test depuis autre dossier
cd /tmp
/home/titane_os/Documents/TITANE_NEWGEN/TITANE_LITE/script.sh
```
