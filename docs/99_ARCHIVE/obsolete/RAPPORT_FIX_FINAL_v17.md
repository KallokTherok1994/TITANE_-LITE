...
**Contexte :** L'utilisateur a essayé de lancer `./validate_v17.sh` et `pnpm tauri dev` depuis le mauvais répertoire (`/home/titane` au lieu de `/home/titane/Documents/TITANE_LITE`).
