...
# Recréer icône
bash ~/Documents/TITANE_LITE/create_desktop_icon.sh
...
```bash
# Tester en terminal
bash ~/Documents/TITANE_LITE/installer_gui/titane_installer.sh
...
bash ~/Documents/TITANE_LITE/test_chat_ia_v19.3.sh
```
