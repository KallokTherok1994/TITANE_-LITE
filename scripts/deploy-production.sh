...
**Full Changelog**: https://github.com/KallokTherok1994/TITANE_LITE/compare/v17.2.0...v${VERSION}
"
    ...
    if gh release create "$tag" \
        ...
        log_info "URL: https://github.com/KallokTherok1994/TITANE_LITE/releases/tag/$tag"
    else
