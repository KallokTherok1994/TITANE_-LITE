...
wget https://raw.githubusercontent.com/KallokTherok1994/TITANE_LITE/main/TITANE_POST_INSTALL_UBUNTU.sh && chmod +x TITANE_POST_INSTALL_UBUNTU.sh
...
- ✅ Repository cloné dans `~/Projets/TITANE_LITE`
...
```bash
cd ~/Projets/TITANE_LITE/src-tauri
cargo clean
cargo build
```
