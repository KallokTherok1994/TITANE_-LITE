...
Le **Pipeline Fix v21** a résolu **100% des erreurs Husky / lint-staged / ESLint / Prettier** qui bloquaient les commits dans TITANE_LITE sur Pop!_OS/Linux.
...
echo "🔧 Pre-commit TITANE_LITE lancé..."
