# TITANE_LITE - Guide de Configuration Développement
...
TITANE_LITE est une application Tauri v2 (Rust + React + TypeScript) nécessitant un environnement de développement spécifique pour le frontend et le backend.
...
git clone git@github.com:KallokTherok1994/TITANE_LITE.git
cd TITANE_LITE
```
...
- Wiki: https://github.com/KallokTherok1994/TITANE_LITE/wiki
...
3. Créer une issue: https://github.com/KallokTherok1994/TITANE_LITE/issues
