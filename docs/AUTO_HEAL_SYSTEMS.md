...
Type=oneshot
User=your-username
WorkingDirectory=/path/to/TITANE_LITE
ExecStart=/path/to/TITANE_LITE/scripts/maintenance/proactive-monitor.sh
...
*/5 * * * * cd /path/to/TITANE_LITE && ./scripts/maintenance/proactive-monitor.sh

# Run health check daily at 2 AM
0 2 * * * cd /path/to/TITANE_LITE && ./scripts/maintenance/health-check-enhanced.sh
```
