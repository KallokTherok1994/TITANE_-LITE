...
**Date:** 2026-01-03  
**Score Actuel:** 95/100 (Tech-Ready (Dev); production en attente d’autorisation)  
...
**Statut Actuel:** ✅ Tech-Ready (Dev) à 95/100
...
cd /path/to/TITANE_LITE/src-tauri
...
gh release create v26.2.3 \
  --title "TITANE∞ v26.2.3 - Tech-Ready (Dev); production en attente d’autorisation" \
...
RELEASE_URL="https://github.com/USER/TITANE_LITE/releases/latest"
