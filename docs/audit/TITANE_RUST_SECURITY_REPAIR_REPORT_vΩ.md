...
```bash
cd /home/titane/Documents/TITANE_LITE/src-tauri
cargo check --lib
```
...
Le projet TITANE_LITE est maintenant **prêt pour la compilation release** et le déploiement en environnement de test.
