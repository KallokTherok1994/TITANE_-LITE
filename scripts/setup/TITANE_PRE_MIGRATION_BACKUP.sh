...
#
# Ce script effectue :
#   1. Sauvegarde complète de TITANE_LITE
...
TITANE_PATH="/home/titane/Documents/TITANE_LITE"
...
log_step "Vérification du projet TITANE_LITE..."
if check_dir_exists "$TITANE_PATH"; then
    TITANE_SIZE=$(get_dir_size "$TITANE_PATH")
    log_success "TITANE_LITE trouvé ($TITANE_SIZE)"
else
    log_error "TITANE_LITE non trouvé à $TITANE_PATH"
    exit 1
fi

# ═══════════════════════════════════════════════════════════════════════════════
# PHASE 1 : SAUVEGARDE TITANE_LITE
# ═══════════════════════════════════════════════════════════════════════════════

log_header "PHASE 1 : SAUVEGARDE TITANE_LITE"
