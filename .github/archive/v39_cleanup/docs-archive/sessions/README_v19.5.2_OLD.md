<!--
  TITANE_LITE v19.5.2 — Proprietary License
...
[![Release](https://img.shields.io/github/v/release/KallokTherok1994/TITANE_LITE)](https://github.com/KallokTherok1994/TITANE_LITE/releases/latest)
[![Tests](https://img.shields.io/badge/tests-100%25_passing-brightgreen)](https://github.com/KallokTherok1994/TITANE_LITE)
[![Build Size](https://img.shields.io/badge/build-25MB-blue)](https://github.com/KallokTherok1994/TITANE_LITE)
[![Boot Time](https://img.shields.io/badge/boot-~2s-brightgreen)](https://github.com/KallokTherok1994/TITANE_LITE)
[![AI Providers](https://img.shields.io/badge/AI_providers-6-purple)](https://github.com/KallokTherok1994/TITANE_LITE)
...
- **[AppImage](https://github.com/KallokTherok1994/TITANE_LITE/releases/download/v19.5.2/TITANE-Infinity_19.2.3_amd64.AppImage)** (80MB) - Portable, all distros ⭐ Recommandé
- **[.deb](https://github.com/KallokTherok1994/TITANE_LITE/releases/download/v19.5.2/TITANE-Infinity_19.2.3_amd64.deb)** (7.7MB) - Debian, Ubuntu, Linux Mint
- **[.rpm](https://github.com/KallokTherok1994/TITANE_LITE/releases/download/v19.5.2/TITANE-Infinity-19.2.3-1.x86_64.rpm)** (7.7MB) - Fedora, RHEL, openSUSE
- **[SHA256SUMS](https://github.com/KallokTherok1994/TITANE_LITE/releases/download/v19.5.2/SHA256SUMS_v19.5.2)** - Checksums validation

### Quick Start

```bash
# AppImage (Recommandé)
wget https://github.com/KallokTherok1994/TITANE_LITE/releases/download/v19.5.2/TITANE-Infinity_19.2.3_amd64.AppImage
chmod +x TITANE-Infinity_19.2.3_amd64.AppImage
./TITANE-Infinity_19.2.3_amd64.AppImage

# Debian/Ubuntu
wget https://github.com/KallokTherok1994/TITANE_LITE/releases/download/v19.5.2/TITANE-Infinity_19.2.3_amd64.deb
sudo dpkg -i TITANE-Infinity_19.2.3_amd64.deb

# Fedora/RHEL
wget https://github.com/KallokTherok1994/TITANE_LITE/releases/download/v19.5.2/TITANE-Infinity-19.2.3-1.x86_64.rpm
...
const DEFAULT_PASSPHRASE: &str = "TITANE_LITE_SOVEREIGN_MEMORY_V8";
```
