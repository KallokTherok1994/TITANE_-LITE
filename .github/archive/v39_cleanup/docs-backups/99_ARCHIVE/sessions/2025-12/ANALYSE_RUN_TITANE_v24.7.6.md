...
1. cd /home/titane-os/Documents/GitHub/TITANE_LITE
...
```bash
cd /home/VOTRE_USER/Documents/GitHub/TITANE_LITE
...
# 2. Alias bash
echo "alias titane='/chemin/vers/TITANE_LITE/run'" >> ~/.bashrc
source ~/.bashrc

# 3. (Optionnel) Lien global
sudo ln -sf /chemin/vers/TITANE_LITE/run /usr/local/bin/titane
```
