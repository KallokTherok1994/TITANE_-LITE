...
pandoc docs/user/README.md docs/user/installation.md docs/user/quickstart.md \
  -o TITANE_LITE_v19.5.2_USER_GUIDE.pdf \
...
```bash
# Download
wget https://github.com/KallokTherok1994/TITANE_LITE/releases/download/v19.5.2/titane-infinity_24.1.0_amd64.AppImage
...
### Linux .deb
```bash
wget https://github.com/KallokTherok1994/TITANE_LITE/releases/download/v19.5.2/titane-infinity_24.1.0_amd64.deb
...
- **Documentation**: https://github.com/KallokTherok1994/TITANE_LITE/tree/TITANE_MAIN/docs/user
...
**GitHub**: https://github.com/KallokTherok1994/TITANE_LITE  
