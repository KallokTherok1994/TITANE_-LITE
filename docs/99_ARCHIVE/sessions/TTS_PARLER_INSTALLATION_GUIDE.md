...
Type=simple
User=titane
WorkingDirectory=/home/titane/Documents/TITANE_LITE/tts-service
ExecStart=/home/titane/Documents/TITANE_LITE/tts-service/venv-parler-tts/bin/python3 tts_api_server.py
Restart=on-failure
RestartSec=10s
...
tail -f /home/titane/Documents/TITANE_LITE/tts-service/logs/tts_api.log
```
...
```bash
rm -rf /home/titane/Documents/TITANE_LITE/tts-service/cache/audio/*
```
