...
if ! curl -s http://localhost:8765/api/v1/tts/health > /dev/null; then
    ...
    echo "   Démarrer avec: /home/titane/Documents/TITANE_LITE/tts-service/start_tts_background.sh"
    exit 1
fi
echo "✅ Service actif"
echo ""
...
echo "   2. Tester le panel: /test/tts dans la fenêtre Tauri (TAURI-ONLY)"
