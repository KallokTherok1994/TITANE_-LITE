...
![CI/CD Status](https://github.com/KallokTherok1994/TITANE_LITE/actions/workflows/ci.yml/badge.svg?branch=MAIN)
...
```bash
wget https://github.com/KallokTherok1994/TITANE_LITE/releases/download/v26.4.0/TITANE-Infinity_26.4.0_amd64.deb
...
📄 [Notes de release complètes](https://github.com/KallokTherok1994/TITANE_LITE/releases/tag/v26.4.0) | 🔐 [SHA256 Checksum](https://github.com/KallokTherok1994/TITANE_LITE/releases/download/v26.4.0/TITANE-Infinity_26.4.0_amd64.deb.sha256)
...
```bash
# 1. Fork & Clone
git clone https://github.com/YOUR_USERNAME/TITANE_LITE.git
cd TITANE_LITE
...
1. ✅ Search [existing issues](https://github.com/KallokTherok1994/TITANE_LITE/issues)
...
- **GitHub:** [KallokTherok1994/TITANE_LITE](https://github.com/KallokTherok1994/TITANE_LITE)
