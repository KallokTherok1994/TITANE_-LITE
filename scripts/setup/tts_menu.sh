...
TTS_DIR="/home/titane/Documents/TITANE_LITE/tts-service"
...
open_docs() {
    ...
    case $DOC_NUM in
        1) xdg-open "/home/titane/Documents/TITANE_LITE/TTS_FINAL_REPORT.md" 2>/dev/null ;;
        2) xdg-open "/home/titane/Documents/TITANE_LITE/TTS_INSTALLATION_SUCCESS.md" 2>/dev/null ;;
        3) xdg-open "/home/titane/Documents/TITANE_LITE/TTS_QUICK_REFERENCE.md" 2>/dev/null ;;
        4) xdg-open "/home/titane/Documents/TITANE_LITE/TTS_PARLER_INSTALLATION_GUIDE.md" 2>/dev/null ;;
        *) echo "❌ Choix invalide" ;;
    esac
}
