...
# 1. Download
cd ~/Downloads
wget https://github.com/KallokTherok1994/TITANE_LITE/releases/download/v27.0.0/Titan-Stable_27.0.0_amd64.AppImage
...
```bash
# Download .deb
wget https://github.com/KallokTherok1994/TITANE_LITE/releases/download/v27.0.0/titane-infinity_27.0.0_amd64.deb
...
```bash
# 1. Download
wget https://github.com/KallokTherok1994/TITANE_LITE/releases/download/v27.0.0/Titan-Stable_27.0.0_x64.dmg
...
```powershell
# 1. Download MSI
Invoke-WebRequest -Uri "https://github.com/KallokTherok1994/TITANE_LITE/releases/download/v27.0.0/Titan-Stable_27.0.0_x64.msi" `
...
- 🐛 **Issue Tracker:** `github.com/KallokTherok1994/TITANE_LITE/issues`
...
- 📦 **Releases:** `github.com/KallokTherok1994/TITANE_LITE/releases`
