...
- ✅ Environnement virtuel: `/home/titane/Documents/TITANE_LITE/tts-service/venv-parler-tts/`
...
- ✅ Logs: `/home/titane/Documents/TITANE_LITE/tts-service/tts_service.log`

### Tests de Validation
```bash
# Test 1: Génération audio (SUCCÈS)
$ cd /home/titane/Documents/TITANE_LITE/tts-service
...
/home/titane/Documents/TITANE_LITE/tts-service/start_tts_background.sh

# Vérifier le statut
curl http://localhost:8765/api/v1/tts/health

# Suivre les logs
tail -f /home/titane/Documents/TITANE_LITE/tts-service/tts_service.log

# Arrêter
kill $(cat /home/titane/Documents/TITANE_LITE/tts-service/tts_service.pid)
```
...
source /home/titane/Documents/TITANE_LITE/tts-service/venv-parler-tts/bin/activate
